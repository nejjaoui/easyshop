...
$GLOBALS['svx'] = isset( $GLOBALS['svx'] ) && version_compare( $GLOBALS['svx'], '1.1.9') == 1 ? $GLOBALS['svx'] : '1.1.9';
			...
			<?php
				woocommerce_wp_select(
					array(
						...
						'value'       => isset( $curr_warranty['preset'] ) && $curr_warranty['preset'] !== '' ? esac_attr( $curr_warranty['preset'] ) : '',
